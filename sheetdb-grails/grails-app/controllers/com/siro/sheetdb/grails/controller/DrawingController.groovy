        ...
        if (drawingInstance) {
            if (params.version) {
                ...
                if (drawingInstance.version > version) {
                    ...
                    drawingInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'drawing.label', default: 'Drawing')] as Object[], "Another user has updated this Drawing while you were editing")
