            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.created.label" default="Created" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${productInstance?.created}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.drawings.label" default="Drawings" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${productInstance.drawings}" var="d">
                                    <li><g:link controller="drawing" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></li>
                                </g:each>
                                </ul>
                            </td>
